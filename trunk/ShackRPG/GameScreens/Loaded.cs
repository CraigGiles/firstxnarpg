...
namespace ShackRPG.GameScreens 
{
    class Loaded : IGameScreen
    {
        ...
        public Loaded(ContentManager sContent, SpriteBatch sSpriteBatch, BaseGame sGame, SpriteFont sFont)
        {
        ...
        public void Draw(GameTime gameTime)
        {
            if (draw)
            {
                ...
                batch.DrawString(font, "Progress Loaded", new Vector2(245, 250), Color.DarkCyan);
